...
import { User, ChevronDown, AlertTriangle, FileText, ArrowUp } from 'lucide-react';
      ...
      <table className="w-full border-collapse text-sm text-left border border-gray-200">
        <thead>
          <tr className="border-b border-gray-200 bg-gray-50/50">
            ...
            <th className="p-2 font-semibold text-gray-600 border-r border-gray-100">Case & Details</th>
            <th className="p-2 font-semibold text-gray-600 border-r border-gray-100 w-48">Assigned Officer</th>
            <th className="p-2 font-semibold text-gray-600 border-r border-gray-100 w-48">Reporter</th>
            <th className="p-2 font-semibold text-gray-600 border-r border-gray-100 w-32">Severity</th>
