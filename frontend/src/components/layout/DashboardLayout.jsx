      ...
      <div className="flex flex-1 overflow-hidden h-[calc(100vh-3rem)]">
        ...
        <aside className={`${isSidebarOpen ? 'w-64 border-r border-gray-100' : 'w-0 overflow-hidden'} bg-white flex flex-col hidden md:flex overflow-y-auto py-4 transition-all duration-200 shrink-0`}>
          ...
          <div className="min-w-[256px]">
            <Link to="/dashboard" className={`flex items-center gap-4 px-6 py-2.5 text-sm font-medium rounded-r-full mr-4 ${isActive('/dashboard') && location.pathname !== '/dashboard/notifications' ? 'bg-green-50 text-green-700' : 'text-gray-700 hover:bg-gray-100'}`}>
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
              Overview
            </Link>

            <Link to="/dashboard/notifications" className={`flex items-center gap-4 px-6 py-2.5 text-sm font-medium rounded-r-full mr-4 mt-2 ${isActive('/dashboard/notifications') ? 'bg-green-50 text-green-700' : 'text-gray-700 hover:bg-gray-100'}`}>
