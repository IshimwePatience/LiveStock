...
const DashboardSkeletonBackground = ({ children }) => {
  return (
    <div className="min-h-screen w-full relative bg-gray-100 flex flex-col font-sans overflow-hidden select-none">
      ...
      <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 sticky top-0 z-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="w-8 h-8 rounded-full bg-gray-200 animate-pulse"></div>
          <div className="w-8 h-8 rounded-full bg-gray-200 animate-pulse"></div>
          <div className="w-8 h-8 rounded-full bg-blue-200 animate-pulse ml-2"></div>
        </div>
      </header>
      ...
      <div className="flex flex-1 overflow-hidden h-[calc(100vh-4rem)]">
        ...
        <aside className="w-64 bg-white border-r border-gray-200 py-6 px-4 flex-col gap-3 shrink-0 hidden md:flex">
          <div className="w-full h-9 rounded-xl bg-blue-100 animate-pulse"></div>
        ...
        <main className="flex-1 p-6 bg-gray-50 flex flex-col gap-6 overflow-hidden">
          {/* Title Placeholder */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-1">
            <div className="rounded-2xl bg-white border border-gray-200 p-5 flex flex-col gap-4 animate-pulse">
              ...
              <div className="flex items-center gap-6 mt-2">
                <div className="w-28 h-28 rounded-full border-8 border-gray-200 shrink-0"></div>
      ...
      {/* 3. Dark Backdrop Overlay & Centered Modal Dialog Container */}
      <div className="absolute inset-0 bg-slate-900/40 backdrop-blur-[2px] z-30 flex items-center justify-center p-4 overflow-y-auto">
        {children}
      </div>
    </div>
  );
